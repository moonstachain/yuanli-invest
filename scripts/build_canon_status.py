...
def build():
    ...
    return {
        ...
        "architecture_lineage": {
            "YIP0": {"role": "philosophy_authority", "status": yip0["status"], "completion_gate": yip0["next_gate"]},
            "OS_VNEXT": {"role": "human_research_grammar", "status": "active_semantic_authority", "human_navigation": "势信极_真价生", "fabricated_lifecycle_receipt": False},
            "ME0": {"role": "return_engine_ontology", "status": me0["status"], "completion_gate": me0["next_gate"], "next_me_stage_authorized": me0["next_me_stage_authorized"]},
            "ME1": {"role": "state_object_model", "status": me1["status"], "completion_gate": me1["next_gate"], "next_me_stage_authorized": me1["next_me_stage_authorized"]},
        ...
        "parallel_programs": {
            "research_capability_program": {"last_authoritative_stage": "QXM2", "status": qxm2["status"], "next_gate": qxm2["next_gate"], "qxm_f_next_gate": qxm2.get("qxm_f_next_gate")},
            "multi_engine_program": {"last_completed_stage": "ME1", "completion_gate": me1["next_gate"], "next_stage": "ME2", "authorized": me1["implementation_authorities"]["ME2"]},
        },
        ...
        "stages": {
            ...
            "R2_3A": {
                "status": r23a["status"], "purpose": r23a["purpose"], "human_gate": r23a["human_gate"]["token"], "human_gate_decision": r23a["human_gate"]["decision"], "human_acceptance_receipt": r23a["human_gate"]["acceptance_receipt"], "merge_commit": r23a["merge_commit"], "merge_receipt": r23a["merge_receipt"], "merge_authority": r23a["merge_authority"], "post_acceptance_ci": r23a["post_acceptance_qualification"],
            },
            "R2_3B0": {
                "status": r23b0["status"], "purpose": r23b0["purpose"], "human_gate": r23b0["human_gate"]["token"], "human_gate_decision": r23b0["human_gate"]["decision"], "human_acceptance_receipt": r23b0["human_gate"].get("acceptance_receipt"), "machine_qualification": r23b0["machine_qualification"], "human_review_qualification": r23b0.get("human_review_qualification"), "post_acceptance_ci": r23b0.get("post_acceptance_qualification"), "merge_authority": r23b0.get("merge_authority", "not_implied_by_acceptance"), "upstream_dependency_resolved": r23b0["upstream_dependency"]["resolved"],
            },
        ...
        "constitutional_invariants": {
            "x_semantics": "X := (Xs, Xa, Xp)", "xs_mother_concept": "Structural Asymmetry Source", "value_control_point_role": "equity_specialized_implementation", "r_is_fourth_human_world": False, "asset_form_is_not_pricing_model": True, "scalar_pnx_force_macro_score": "prohibited", "evidence_role": "horizontal_claim_control_plane", "claim_authority_cannot_exceed_evidence_authority": True, "lower_level_truth_does_not_imply_higher_level_authorization": True, "research_portfolio_split_changes_x_semantics": False, "ledger_law": "receipt_is_ledger_status_is_projection", "live_execution": "unavailable_by_design",
        },
        ...
        "gate_projection_semantics": "legacy_r2_3b0_single_gate_compatibility_only_use_parallel_programs_for_current_state",
    }
